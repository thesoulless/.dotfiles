# Generated with `brew bundle dump`; this Brewfile is the source of truth for
...
go "robpike.io/ivy"
go "github.com/moderato-app/live-pprof"
...
go "go.temporal.io/sdk/contrib/tools/workflowcheck"
npm "corepack"
